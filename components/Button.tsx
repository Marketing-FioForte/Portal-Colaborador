...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline: "border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 focus:ring-gray-200",
    ghost: "bg-transparent hover:bg-gray-100 text-brand-primary focus:ring-gray-200",
